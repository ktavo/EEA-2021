...
Entre ellos principalmente usaremos __dplyr__ y __tidyr__ para realizar transformaciones sobre nuestro set de datos, __lubridate__ para trabajar con datos tipo fecha, __stringr__ para trabajar con datos tipo string y  __ggplot__ para realizar gráficos
...
## Stringr: manejo de strings ^[Basado en la [clase](https://jmbarriola.github.io/ATR-2019/Clase%205/clase5_strings_y_fechas.nb.html) de Milena Dotta y Juan Barriola]
