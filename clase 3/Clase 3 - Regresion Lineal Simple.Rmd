...
Nuestro objetivo es crear un modelo lineal simple para explicar el sueldo neto de Data Analysts, Data Scientists y Data Engineers en Argentina.

Nuestro idea subyacente de cómo se puede explicar el salario neto es:

$salarioNeto = \beta_0 +\beta_1X+\epsilon$

Vamos a trabajar nuestro set de datos con esta idea de modelo presente.
