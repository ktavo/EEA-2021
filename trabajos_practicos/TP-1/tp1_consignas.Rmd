...
Una vez terminado el notebook deberán entregarlo en formato HTML, según se indica en la guía de procedimiento.
...
2) **Análisis exploratorios (I)**
    ...
    c) ¿Cómo es la correlación entre las variables *surface_total* y *surface_covered*? ¿Y la correlación entre *rooms* y *bathrooms*?   
...
Deberían llegar a un dataset con 51.210 observaciones y 8 variables.
...
5) **Outliers**
    ...
    b) Eliminar los outliers univariados severos de las variables **precio_en_miles**, **rooms** y **surface_total** usando el método de 3 desvíos del rango intercuartil. 
