...
El objetivo general es poder crear un modelo lineal simple para explicar el precio de venta de las propiedades en Capital Federal. Para ello es necesario realizar analisis exploratorios, limpieza del dataset y realizar los modelos.
...
5) **Outliers**
    ...
    b) Eliminar los outliers univariados severos de las variables **precio_en_miles**, **rooms** y **surface_total**.
    Pueden utilizar alguno de los siguientes métodos o combinarlos:
      * criterio del boxplot (rango intercuartil)
      * criterio de los percentiles
