...
En este caso vamos a trabajar con los R Notebooks básicos que se compilan a html, lo cual permite
...
## 3. Compartir el archivo html

Una vez guardado y finalizado, para entregar el archivo en formato html, se deberá generar un knit to HTML, que figura al hacer clic en Preview. 

![](imagenes/knit_html.png){width=300}

Luego se pedirá lo envíen al mail del profesor que les sea asignado. 