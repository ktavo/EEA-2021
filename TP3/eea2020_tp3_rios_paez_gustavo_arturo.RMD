...
titanic_train_test <- initial_split(titanic_train_filter, prop = 0.7)
#Armamos dataframe de testeo y entrenamiento
titanic_split_train <- training(titanic_train_test)
titanic_split_test <- testing(titanic_train_test)
...
```
Vemos una proporción similar a la del dataset antes de su partición, con un 62% de fallecidos. 
